...
/**
 * Provides the local service interface for lakes. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see lakesLocalServiceUtil
...
public interface lakesLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link lakesLocalServiceUtil} to access the lakes local service. Add custom service methods to {@link com.lake.service.impl.lakesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
