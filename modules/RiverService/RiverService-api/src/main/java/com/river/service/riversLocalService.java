...
/**
 * Provides the local service interface for rivers. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see riversLocalServiceUtil
...
public interface riversLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link riversLocalServiceUtil} to access the rivers local service. Add custom service methods to {@link com.river.service.impl.riversLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
